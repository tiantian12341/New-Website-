...
var bootstrap = function ($, sp) {
    ...
    var meuns = {
        ...
        load: function () {
            ...
            for (var i = 0, l = modules.length; i < l; i++) {
                ...
                if (item.F_IsMenu == 1) {
                    ...
                    menuItemHtml += '<span class="sp-menu-item-arrow"><i class="fa fa-angle-left"></i></span></a>';
        ...
        bind: function () {
            ...
            $('#sp_frame_menu a').hover(function () {
                if ($('body').hasClass('sp-menu-closed')) {
                    var id = $(this).attr('id');
            ...
            $('.sp-frame-personCenter .dropdown-toggle').hover(function () {
                if ($('body').hasClass('sp-menu-closed')) {
                    var text = $(this).text();
                    layer.tips(text, $(this));
                }
                ...
                switch (_module.F_Target) {
                    ...
                    case 'expand':// 打开子菜单
                        ...
                        if ($ul.is(':visible')) {
                            ...
                            if ($ul.hasClass('sp-second-menu-list')) {
                                $('#sp_frame_menu .sp-second-menu-list').slideUp(300, function () {
