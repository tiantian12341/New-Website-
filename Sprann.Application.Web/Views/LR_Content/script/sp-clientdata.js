 ...
 *custmerData-----------------自定义数据
 sp.clientdata.getAsync('custmerData', {
        url: url,
        key: value,
        valueId: valueId,
        callback: function (item) {
...
(function ($, sp) {
    ...
    clientDataFn.modules = {
        ...
        init: function () {
            ...
            sp.httpAsyncGet($.rootUrl + '/LR_SystemModule/Module/GetModuleList', function (res) {
    ...
    clientDataFn.userinfo = {
        ...
        init: function () {
            ...
            sp.httpAsyncGet($.rootUrl + '/Login/GetUserInfo', function (res) {
                if (res.code == sp.httpCode.success) {
    ...
    clientAsyncData.company = {
        ...
        init: function () {
            if (clientAsyncData.company.states == loadSate.no) {
                ...
                sp.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/Company/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.department = {
        ...
        init: function () {
            if (clientAsyncData.department.states == loadSate.no) {
                ...
                sp.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/Department/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.user = {
        ...
        init: function () {
            if (clientAsyncData.user.states == loadSate.no) {
                ...
                sp.httpAsync('GET', top.$.rootUrl + '/LR_OrganizationModule/User/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.dataItem = {
        ...
        init: function () {
            if (clientAsyncData.dataItem.states == loadSate.no) {
                ...
                sp.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/DataItem/GetMap', { ver: ver }, function (data) {
                    if (!data) {
        ...
        get: function (op) {
            ...
            if (clientAsyncData.dataItem.states == loadSate.ing) {
                ...
                if (_item) {
                    top.sp.language.get(_item.text, function (text) {
                        _item.text = text;
        ...
        getAll: function (op) {
            ...
            if (clientAsyncData.dataItem.states == loadSate.ing) {
                ...
                $.each(data[op.code] || {}, function (_index, _item) {
                    _item.text = top.sp.language.getSyn(_item.text);
                    res[_index] = _item;
                });
                op.callback(res, op);
            }
    ...
    clientAsyncData.db = {
        ...
        init: function () {
            if (clientAsyncData.db.states == loadSate.no) {
                ...
                sp.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/DatabaseLink/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.sourceData = {
        ...
        load: function (code) {
            ...
            sp.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/DataSource/GetMap', { code: code, ver: ver }, function (data) {
                if (!data) {
    ...
    clientAsyncData.custmerData = {
        ...
        load: function (url) {
            sp.httpAsync('GET', top.$.rootUrl + url, {}, function (data) {
                if (!!data) {
                    clientData[url] = data;
                }
