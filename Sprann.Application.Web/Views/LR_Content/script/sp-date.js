(function ($, sp) {
    ...
    $.extend(sp, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = sp.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = sp.parseDate(sp.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = sp.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = sp.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = sp.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = sp.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return sp.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
