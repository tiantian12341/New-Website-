        ...
        bind: function () {
            ...
            sp.clientdata.getAllAsync('sourceData', {
                ...
                callback: function (_data) {
                    var treeData = $.sptree.listTotree(_data, op.treeParentId, op.treeValueId, op.treeTextId, op.treeValueId, false);
                    $('#tree').sptree({
                        data: treeData,
            ...
            $('.selected-item-list-warp').spscroll();
