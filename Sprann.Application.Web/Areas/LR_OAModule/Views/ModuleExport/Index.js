...
var bootstrap = function ($, sp) {
    ...
    var page = {
        ...
        init: function () {
            $.spSetForm(top.$.rootUrl + '/LR_OAModule/ModuleExport/GetFormData?keyValue=3587a099-980d-4342-864f-a9f48e90e03b', function (data) {//
                $('.price-info').spSetFormData(data.customerData);
                var html = "";
        ...
        bind:function(){
            ...
            $("#btn_export_Excel").on('click', function () {
                sp.download({ url: top.$.rootUrl + '/LR_OAModule/ModuleExport/ExportExcel', param: { keyValue: "3587a099-980d-4342-864f-a9f48e90e03b", __RequestVerificationToken: $.spToken }, method: 'POST' });
            });
            //导出Word
            $("#btn_export_Word").on('click', function () {
                sp.download({ url: top.$.rootUrl + '/LR_OAModule/ModuleExport/ExportWord', param: { keyValue: "3587a099-980d-4342-864f-a9f48e90e03b", __RequestVerificationToken: $.spToken }, method: 'POST' });
            });
            //导出PDF
            $("#btn_export_PDF").on('click', function () {
                sp.download({ url: top.$.rootUrl + '/LR_OAModule/ModuleExport/ExportPDF', param: { __RequestVerificationToken: $.spToken }, method: 'POST' });
            });
        }
    };
    page.init();
