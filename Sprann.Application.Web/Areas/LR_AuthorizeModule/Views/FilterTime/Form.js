...
var bootstrap = function ($, sp) {
    ...
    var page = {
        ...
        initData: function () {
            $.spSetForm(top.$.rootUrl + '/LR_AuthorizeModule/FilterTime/GetFormData?keyValue=' + objectId, function (data) {
                var formdata = data || {};
    ...
    acceptClick = function () {
        ...
        $.spSaveForm(top.$.rootUrl + '/LR_AuthorizeModule/FilterTime/SaveForm', postData, function (res) { });
