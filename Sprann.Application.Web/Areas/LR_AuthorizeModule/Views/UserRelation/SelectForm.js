...
var bootstrap = function ($, sp) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            // 公司
            $('#company_select').spCompanySelect({ isLocal: true }).bind('change', function () {
    ...
    acceptClick = function () {
        $.spSaveForm(top.$.rootUrl + '/LR_AuthorizeModule/UserRelation/SaveForm', { objectId: objectId, category: category, userIds: String(userlistselected) }, function (res) { });
        return true;
    };
    page.init();
}