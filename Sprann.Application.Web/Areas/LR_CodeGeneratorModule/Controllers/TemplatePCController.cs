using Sprann.Application.Base.CodeGeneratorModule;
            ...
            foreach (var btn in colDataObj.btns)
            {
                switch (btn)
                {
                    case "add":
                        ...
                        addButtonEntity.F_EnCode = "sp_add";
                    ...
                    case "edit":
                        ...
                        editButtonEntity.F_EnCode = "sp_edit";
                    ...
                    case "delete":
                        ...
                        deleteButtonEntity.F_EnCode = "sp_delete";
                    ...
                    case "print":
                        ...
                        printButtonEntity.F_EnCode = "sp_print";
