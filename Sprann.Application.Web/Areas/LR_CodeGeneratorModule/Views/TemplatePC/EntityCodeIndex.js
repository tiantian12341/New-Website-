...
var bootstrap = function ($, sp) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        sp.httpAsyncPost(top.$.rootUrl + '/LR_CodeGeneratorModule/TemplatePC/LookEntityCode', postData, function (res) {
                            if (res.code == 200) {
        ...
        /*保存数据*/
        save: function () {
            $.spSaveForm(top.$.rootUrl + '/LR_CodeGeneratorModule/TemplatePC/CreateEntityCode', postData, function (res) { });
        }
    };
