...
namespace Sprann.Util
{
    ...
    public class WebHelper
    {
        ...
        /// 主题Cookie名称
        /// </summary>
        public const string UIThemeCookieName = "SprannMesPortalUItheme";
        ...
        {
            string res = "sp-uitheme-default";
            try
            {
                string learn_UItheme = WebHelper.GetCookie(UIThemeCookieName);
                switch (learn_UItheme)
                {
                    case "1":
                        res = "sp-uitheme-default";     // 经典版本
                        break;
                    case "2":
                        res = "sp-uitheme-accordion";   // 手风琴版本
                        break;
                    case "3":
                        res = "sp-uitheme-windos";      // Windos版本
                        break;
                    case "4":
                        res = "sp-uitheme-top";        // 顶部菜单版本
                        break;
                    default:
                        res = "sp-uitheme-default";     // 经典版本
                        break;
