...
namespace Sprann.Util
{
    ...
    public static class CommonHelper
    {
        ...
        #region 常用数据转换， Ridge 2018-12-20
        /// <summary>
        /// 转换到特定数值类型
        /// </summary>
        public static TData To<TData>(this object rawObj)
        {
            Converter<object, TData> gConvert = new Converter<object, TData>(s =>
            {
                if (rawObj == null)
                {
            ...
            return gConvert(rawObj);
        }

        /// <summary>
        /// 无异常转换到特定数值类型
        /// </summary>
        public static TData As<TData>(this object rawObj)
        {
