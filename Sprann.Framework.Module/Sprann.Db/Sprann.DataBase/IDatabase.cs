...
namespace Sprann.DataBase
{
    ...
    public interface IDatabase
    {
        ...
        /// <param name="dbParameter">参数</param>
        /// <returns></returns>
        DataTable FindTableByProc(string procName, object dbParameter);
        ...
        /// <param name="dbParameter">参数</param>
        /// <returns></returns>
        DataSet FindDataSetByProc(string procName, object dbParameter);
        #endregion
        ...
        /// <param name="total">总共数据条数</param>
        /// <returns></returns>
        DataSet FindDataSet(string strSql, object dbParameter, string orderField, bool isAsc, int pageSize, int pageIndex, out int total);
