...
using Sprann.Application.BaseModule.CodeGeneratorModule;
using Sprann.Util;
using System;
...
namespace Sprann.Application.Base.CodeGeneratorModule
{
    /// <summary>
    /// 版 本 Sprann ADMS V1.0.0 敏捷开发框架
    /// Copyright (c) 2013-2018 思普瑞云(深圳)科技有限公司
    ...
    public class CodeGenerator
    {
        ...
        private string NotesCreate(CodeBaseConfigModel baseConfigModel) {
            ...
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 Sprann ADMS V1.0.0 敏捷开发框架\r\n");
            sb.Append("    /// Copyright (c) 2017-2018 思普瑞云(深圳)科技有限公司\r\n");
        ...
        public string MappingCreate(CodeBaseConfigModel baseConfigModel, string tableName)
        {
            try
            {
                ...
                sb.Append("namespace  Sprann.Application.Mapping\r\n");
                sb.Append("{\r\n");
                //sb.Append(NotesCreate(baseConfigModel));
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("using Sprann.DataBase.Repository;\r\n");
                sb.Append("using Sprann.Util;\r\n");
                sb.Append("using System;\r\n");
                ...
                content += "                strSql.Append(fieldSql);\r\n";
                content += "                strSql.Append(\" FROM " + baseConfigModel.tableName + " t \");\r\n";
                //content += "                var user = LoginUserInfo.Get();\r\n";
                //content += "                if (!user.isSystem)\r\n";
                //content += "                {\r\n";
                //content += "                strSql.Append($\" WHERE gcdm = '{user.company}'  \");\r\n";
                //content += "                }\r\n";
                content += "                var jObject = queryJson.ToJObject();\r\n";
                ...
                sb.Append("        public void DeleteEntity(int? keyValue)\r\n");
                content = "";
                if(pk  == "")
                {
                    pk = "id";
                ...
                sb.Append("        public void SaveEntity(int? keyValue, " + baseConfigModel.tableName + "Entity entity)\r\n");
                content = "";
                content += "                if (!string.IsNullOrEmpty(keyValue.ToString()))\r\n";
                content += "                {\r\n";
        ...
        public string IBllCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("        void DeleteEntity(int? keyValue);\r\n");
                ...
                sb.Append("        void SaveEntity(int? keyValue, " + baseConfigModel.tableName + "Entity entity);\r\n");
        ...
        public string BllCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                // 函数传入参数
                //string paramStr = "string keyValue, " + mainTable + "Entity entity,";
                string paramStr = "int? keyValue, " + mainTable + "Entity entity,";
        ...
        public string ControllerCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("namespace Sprann.Application.Web.Areas." + baseConfigModel.area + ".Controllers\r\n");
                sb.Append("{\r\n");
                //sb.Append(NotesCreate(baseConfigModel));
                ...
                sb.Append("        public ActionResult DeleteForm(int? keyValue)\r\n");
                sb.Append("        {\r\n");
                ...
                sb.Append("        public ActionResult SaveForm(int? keyValue," + baseConfigModel.tableName + "Entity entity)\r\n");
                sb.Append("        {\r\n");
        ...
        public string ControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("namespace Sprann.Application.Web.Areas." + baseInfo.outputArea + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
        ...
        public string IndexCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                //sb.Append("<div class=\"sp-layout sp-layout-left-center\" id=\"sp_layout\">\r\n");
                //sb.Append("    <div class=\"sp-layout-left\">\r\n");
                //sb.Append("        <div class=\"sp-layout-wrap\">\r\n");
                //sb.Append("            <div class=\"sp-layout-title\">树形目录</div>\r\n");
                //sb.Append("            <div id=\"tree\" class=\"sp-layout-body\"></div>\r\n");
                //sb.Append("        </div>\r\n");
                //sb.Append("    </div>\r\n");
                sb.Append(" <div class=\"sp-layout-center\">\r\n");
                sb.Append("     <div class=\"sp-layout-wrap\">\r\n");
                sb.Append("         <div class=\"sp-layout-title\">标题</div>\r\n");
                sb.Append("         <div class=\"sp-layout-tool\">\r\n");
                sb.Append("             <div class=\"sp-layout-tool-left\">\r\n");
                sb.Append("                 <div class=\"sp-layout-tool-item\">\r\n");
                ...
                sb.Append("                 </div>\r\n");
                sb.Append("             </div>\r\n");
                sb.Append("             <div class=\"sp-layout-tool-right\">\r\n");
                sb.Append("                 <div class=\" btn-group btn-group-sm\">\r\n");
                sb.Append("                     <a id=\"sp_refresh\" class=\"btn btn-default\"><i class=\"fa fa-refresh\"></i></a>\r\n");
                sb.Append("                 </div>\r\n");
                sb.Append("                 <div class=\" btn-group btn-group-sm\" sp-authorize=\"yes\">\r\n");
                sb.Append("                     <a id=\"sp_add\"   class=\"btn btn-default sp-btn-add\"><i class=\"fa fa-plus\"></i>&nbsp;新增</a>\r\n");
                sb.Append("                     <a id=\"sp_edit\"  class=\"btn btn-default sp-btn-edit\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;编辑</a>\r\n");
                sb.Append("                     <a id=\"sp_delete\" class=\"btn btn-default sp-btn-delete\"><i class=\"fa fa-trash-o\"></i>&nbsp;删除</a>\r\n");
                sb.Append("                 </div>\r\n");
                sb.Append("             </div>\r\n");
                sb.Append("         </div>\r\n");
                sb.Append("         <div class=\"sp-layout-body\" id=\"gridtable\"></div>\r\n");
                sb.Append("     </div>\r\n");
                sb.Append(" </div>\r\n\r\n");
                //sb.Append("</div>\r\n");
        ...
        public string IndexCreate(BaseModel baseInfo, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData)
        {
            try
            {
                ...
                sb.Append("<div class=\"sp-layout " + (colData.isTree == "1" ? "sp-layout-left-center\"  id=\"sp_layout\" " : "\"") + "  >\r\n");
                if (colData.isTree == "1") {
                    sb.Append("    <div class=\"sp-layout-left\">\r\n");
                    sb.Append("        <div class=\"sp-layout-wrap\">\r\n");
                    sb.Append("            <div class=\"sp-layout-title splg \">树形列表</div>\r\n");
                    sb.Append("            <div id=\"dataTree\" class=\"sp-layout-body\"></div>\r\n");
                    sb.Append("        </div>\r\n");
                    sb.Append("    </div>\r\n");
                }

                sb.Append("    <div class=\"sp-layout-center\">\r\n");
                sb.Append("        <div class=\"sp-layout-wrap "+ (colData.isTree == "1" ? "" : "sp-layout-wrap-notitle") + " \">\r\n");

                if (colData.isTree == "1")
                {
                    sb.Append("            <div class=\"sp-layout-title\">\r\n");
                    sb.Append("                <span id=\"titleinfo\" class=\"splg\">列表信息</span>\r\n");
                    sb.Append("            </div>\r\n");
                }
                ...
                if (queryData.fields.Count > 0)
                {
                    ...
                    sb.Append("                            <div class=\"sp-query-formcontent\">\r\n");
                    foreach (var item in queryData.fields)
                    {
                        CodeFormCompontModel compont = compontMap[item.id];
                        sb.Append("                                <div class=\"col-xs-" + (12 / Convert.ToInt32(item.portion)) + " sp-form-item\">\r\n");
                        sb.Append("                                    <div class=\"sp-form-item-title\">" + compont.title + "</div>\r\n");
                ...
                if (colData.btns.Length > 0)
                {
                    ...
                    foreach (string btn in colData.btns) {
                        switch (btn) {
                            case "add":
                                sb.Append("                        <a id=\"sp_add\"   class=\"btn btn-default\"><i class=\"fa fa-plus\"></i>&nbsp;新增</a>\r\n");
                                break;
                            case "edit":
                                sb.Append("                        <a id=\"sp_edit\"  class=\"btn btn-default\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;编辑</a>\r\n");
                                break;
                            case "delete":
                                sb.Append("                        <a id=\"sp_delete\" class=\"btn btn-default\"><i class=\"fa fa-trash-o\"></i>&nbsp;删除</a>\r\n");
                                break;
                            case "print":
                                sb.Append("                        <a id=\"sp_print\"   class=\"btn btn-default\"><i class=\"fa fa-print\"></i>&nbsp;打印</a>\r\n");
                                break;
                        }
                    }
                    sb.Append("                    </div>\r\n");
                    ...
                    foreach (string btn in colData.btns)
                    {
                        switch (btn)
                        {
                            case "add":
                                ...
                                break;
                            case "save":
                                sb.Append("                        <a id=\"sp_save\"  class=\"btn btn-default\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;保存</a>\r\n");
                                break;
                            case "delete":
                                sb.Append("                        <a id=\"sp_delete\" class=\"btn btn-default\"><i class=\"fa fa-trash-o\"></i>&nbsp;删除</a>\r\n");
                                break;
        ...
        public string ReportIndexCreate(BaseModel baseInfo, QueryModel queryData)
        {
            try
            {
                ...
                sb.Append("<div class=\"sp-layout\" >\r\n");

                sb.Append("    <div class=\"sp-layout-center\">\r\n");
                sb.Append("        <div class=\"sp-layout-wrap sp-layout-wrap-notitle \">\r\n");
                sb.Append("            <div class=\"sp-layout-tool\">\r\n");
                sb.Append("                <div class=\"sp-layout-tool-left\">\r\n");
                if (queryData.isDate == "1")
                {
                ...
                if (queryData.fields.Count > 0)
                {
                    ...
                    {
                        sb.Append("                                <div class=\"col-xs-" + (12 / Convert.ToInt32(item.portion)) + " sp-form-item\">\r\n");
                        sb.Append("                                    <div class=\"sp-form-item-title\">" + item.name + "</div>\r\n");
                ...
                sb.Append("                    </div>\r\n");
                sb.Append("                    <div class=\" btn-group btn-group-sm\" learun-authorize=\"yes\">\r\n");
                sb.Append("                        <a id=\"sp_outport\"   class=\"btn btn-default\"><i class=\"fa fa-sign-out\"></i>&nbsp;导出</a>\r\n");
                sb.Append("                        <a id=\"sp_print\"   class=\"btn btn-default\"><i class=\"fa fa-print\"></i>&nbsp;打印</a>\r\n");
                sb.Append("                    </div>\r\n");
                sb.Append("                </div>\r\n");
                sb.Append("            </div>\r\n");
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("var bootstrap = function ($, sp) {\r\n");
                ...
                sb.Append("            });\r\n\r\n");
                //sb.Append("            // 刷新\r\n");
                sb.Append("            $('#sp_refresh').on('click', function () {\r\n");
                sb.Append("                sp.spLoading(true, '刷新中');\r\n");
                sb.Append("                window.location.reload();\r\n");
                sb.Append("            });\r\n\r\n");
                //sb.Append("            // 新增\r\n");
                sb.Append("            $('#sp_add').on('click', function () {\r\n");
                sb.Append("                selectedRow = null;\r\n");
                sb.Append("                sp.layerForm({\r\n");
                sb.Append("                    id: 'form',\r\n");
                sb.Append("                    title: '新增',\r\n");
                ...
                sb.Append("            });\r\n\r\n");
                //sb.Append("            // 删除\r\n");
                sb.Append("            $('#sp_delete').on('click', function () {\r\n");
                sb.Append("                var keyValue = $('#gridtable').jfGridValue('" + pk + "');\r\n");
                sb.Append("                if (sp.checkrow(keyValue)) {\r\n");
                sb.Append("                    sp.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            sp.deleteForm(top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                sb.Append("                                 page.search();\r\n");
                sb.Append("                                 $('#gridtable')[0]['dfop']['running']['rowSelected'] = null;\r\n");
                sb.Append("                            });\r\n");
                sb.Append("                        }\r\n");
                sb.Append("                    });\r\n");
                sb.Append("                }\r\n");
                ...
                sb.Append("            $('#gridtable').spAuthorizeJfGrid({\r\n");
        ...
        public string IndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                if (queryData.fields.Count > 0)
                {
                    sb.Append("            $('#multiple_condition_query').spMultipleQuery(function (queryJson) {\r\n");
                    ...
                    foreach (var item in queryData.fields)
                    {
                        ...
                        if (compont.type == "select")
                        {
                            ...
                            {
                                sb.Append("            $('#" + compont.field + "').spDataItemSelect({ code: '" + compont.itemCode + "' });\r\n");
                            }
                            else
                            {
                                string[] vlist = compont.dataSourceId.Split(',');
                                sb.Append("            $('#" + compont.field + "').spDataSourceSelect({ code: '" + vlist[0] + "',value: '" + vlist[2] + "',text: '" + vlist[1] + "' });\r\n");
                            }
                        }
                        else if (compont.type == "organize" || compont.type == "currentInfo")
                        {
                            ...
                            {
                                sb.Append("            $('#" + compont.field + "').spCompanySelect();\r\n");
                            }
                            else if (compont.dataType == "department")
                            {
                                sb.Append("            $('#" + compont.field + "').spDepartmentSelect();\r\n");
                            }
                            else if (compont.dataType == "user")
                            {
                                sb.Append("            $('#" + compont.field + "').spUserSelect(0);\r\n");
                            }
                        }
                        else if (compont.type == "radio" || compont.type == "checkbox")
                        {

                            sb.Append("            $('#" + compont.field + "').spRadioCheckbox({\r\n");
                ...
                foreach (var btn in colData.btns) {
                    switch (btn) {
                        ...
                        case "print":
                            sb.Append("            // 打印\r\n");
                            sb.Append("            $('#sp_print').on('click', function () {\r\n");
            ...
            try
            {
                ...
                foreach (var btn in colData.btns)
                {
                    switch (btn)
                    {
                        ...
                        case "save":
                            sb.Append("            // 保存\r\n");
                            sb.Append("            $('#sp_save').on('click', function () {\r\n");
                            ...
                            sb.Append("                    $.spSaveForm(top.$.rootUrl +  '/" + baseInfo.outputArea + "/" + baseInfo.name + "/SaveList', { list: postData }, function (res) {\r\n");
                            sb.Append("                        refreshGirdData();\r\n");
                            sb.Append("                    });\r\n");
                            sb.Append("                }\r\n");
                            sb.Append("                else {\r\n");
                    ...
                    switch (compont.type)
                    {
                        ...
                        case "select":
                            ...
                            if (compont.dataSource == "0")
                            {
                                ...
                                sb.Append("                                    });\r\n");
                                sb.Append("                                    $edit.spselectRefresh({\r\n");
                                sb.Append("                                        data: list\r\n");
                                sb.Append("                                    });\r\n");
                                sb.Append("                                }\r\n");
                                sb.Append("                            });\r\n");
        ...
        public string ReportIndexJSCreate(BaseModel baseInfo, List<ReportColModel> collist, QueryModel queryData)
        {
            try
            {
                ...
                sb.Append("            // 导出\r\n");
                sb.Append("            $('#sp_outport').on('click', function () {\r\n");
        ...
        private void CreateFormCompont(StringBuilder sb, List<CodeFormCompontModel> componts)
        {
            foreach (var compont in componts)
            {
                if (compont.type == "label") {
                    sb.Append("    <div class=\"col-xs-" + (12 / Convert.ToInt32(compont.proportion)) + " sp-form-item\" style=\"padding:0;line-height:38px;text-align:center;font-size:20px;font-weight:bold;color:#333;\" >\r\n");
                    sb.Append("        <span>" + compont.table + "</span>\r\n");
                    sb.Append("    </div>\r\n");
                }
                else if (compont.type == "girdtable")
                {
                    sb.Append("    <div class=\"col-xs-12 sp-form-item sp-form-item-grid\" >\r\n");
                    sb.Append("        <div id=\"" + compont.table + "\"></div>\r\n");
                    sb.Append("    </div>\r\n");
                }
                else
                {
                    sb.Append("    <div class=\"col-xs-" + (12 / Convert.ToInt32(compont.proportion)) + " sp-form-item\"  data-table=\"" + compont.table + "\" >\r\n");
                    sb.Append("        <div class=\"sp-form-item-title\">" + compont.title + GetFontHtml(compont.verify) + "</div>\r\n");
                    ...
                    switch (compont.type)
                    {
                        ...
                        case "datetime":
                            ...
                            sb.Append("        <input id=\"" + compont.field + "\" type=\"text\" class=\"form-control sp-input-wdatepicker\" onfocus=\"WdatePicker({ dateFmt:'" + dateformat + "',onpicked: function () { $('#" + compont.field + "').trigger('change'); } })\"  " + strValid + " />\r\n");
                            break;
                        case "encode":
                            sb.Append("        <input id=\"" + compont.field + "\" type=\"text\" readonly class=\"form-control\" />\r\n");
                            break;
                        case "currentInfo":
                            sb.Append("        <input id=\"" + compont.field + "\" type=\"text\" readonly class=\"form-control currentInfo sp-currentInfo-"+ compont.dataType + "\" />\r\n");
                            break;
                    }
                    sb.Append("    </div>\r\n");
                }
        ...
        public string FormCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                IEnumerable<DatabaseTableFieldModel> fieldList = databaseTableIBLL.GetTableFiledList(baseConfigModel.databaseLinkId, baseConfigModel.tableName);
                sb.Append("<div class=\"sp-form-wrap\" id=\"form\">\r\n");
                foreach (var fileditem in fieldList)
                {
                    sb.Append("    <div class=\"col-xs-6 sp-form-item\">\r\n");
                    sb.Append("        <div class=\"sp-form-item-title\">" + fileditem.f_remark + "<font face=\"宋体\">*</font></div>\r\n");
        ...
        public string FormCreate(BaseModel baseInfo, List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap)
        {
            try
            {
                ...
                {
                    sb.Append("<div class=\"sp-form-wrap\">\r\n");
                    CreateFormCompont(sb, formData[0].componts);
                    sb.Append("</div>\r\n");
                }
                else// 多个选项卡的时候
                {
                    sb.Append("<div class=\"sp-form-tabs\" id=\"sp_form_tabs\">\r\n");
                    ...
                    sb.Append("    </ul>\r\n</div>\r\n");
                    num = 1;
                    sb.Append("<div class=\"tab-content sp-tab-content\" id=\"sp_tab_content\">\r\n");
                    foreach (var tab in formData)
                    {
                        sb.Append("<div class=\"sp-form-wrap tab-pane\" id=\"tab" + num + "\">\r\n");
        ...
        public string FormJsCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("var bootstrap = function ($, sp) {\r\n");
                sb.Append("    \"use strict\";\r\n\r\n");
                sb.Append("    var selectedRow = sp.frameTab.currentIframe().selectedRow;\r\n\r\n");
                sb.Append("    var page = {\r\n");
                sb.Append("        init: function () {\r\n");
                ...
                sb.Append("                $('#form').spSetFormData(selectedRow);\r\n");
                sb.Append("            }\r\n");
                sb.Append("        }\r\n");
                sb.Append("    };\r\n");
                //sb.Append("    // 保存数据\r\n");
                sb.Append("    acceptClick = function (callBack) {\r\n");
                sb.Append("        if (!$('#form').spValidform()) {\r\n");
                sb.Append("            return false;\r\n");
                sb.Append("        }\r\n");
                sb.Append("        var postData = $('#form').spGetFormData(keyValue);\r\n");
                sb.Append("        $.spSaveForm(top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/SaveForm?keyValue=' + keyValue, postData, function (res) {\r\n");
                //sb.Append("            // 保存成功后才回调\r\n");
        ...
        public string FormJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, List<CodeFormTabModel> formData,Dictionary<string, CodeFormCompontModel> compontMap)
        {
            try
            {
                ...
                sb.Append("    var page = {\r\n");
                sb.Append("        init: function () {\r\n");
                sb.Append("            $('.sp-form-wrap').spscroll();\r\n");
                sb.Append("            page.bind();\r\n");
                sb.Append("            page.initData();\r\n");
                sb.Append("        },\r\n");
                sb.Append("        bind: function () {\r\n");
                ...
                if (formData.Count > 1)
                {
                    sb.Append("            $('#sp_form_tabs').spFormTab();\r\n");
                    sb.Append("            $('#sp_form_tabs ul li').eq(0).trigger('click');\r\n");
                }
                    ...
                    foreach (var compont in tab.componts)
                    {
                        switch (compont.type)
                        {
                            ...
                            case "organize":
                                switch (compont.dataType)
                                {
                                    case "user"://用户
                                        ...
                                        {
                                            sb.Append("            $('#" + compont.field + "').spformselect({\r\n");
                                        ...
                                        {
                                            sb.Append("            $('#" + compont.field + "').spselect({\r\n");
                                            ...
                                            sb.Append("                var value = $(this).spselectGet();\r\n");
                                            sb.Append("                if (value == '')\r\n");
                                            sb.Append("                {\r\n");
                                            sb.Append("                    $('#" + compont.field + "').spselectRefresh({\r\n");
                                            sb.Append("                        url: '',\r\n");
                                            sb.Append("                        data: []\r\n");
                                            sb.Append("                    });\r\n");
                                            sb.Append("                }\r\n");
                            ...
                            case "currentInfo":
                                switch (compont.dataType) {
                                    case "company":
                                        sb.Append("            $('#" + compont.field + "')[0].spvalue = learun.clientdata.get(['userinfo']).companyId;\r\n");
                                        ...
                                        break;
                                    case "department":
                                        sb.Append("            $('#" + compont.field + "')[0].spvalue = learun.clientdata.get(['userinfo']).departmentId;\r\n");
                                        ...
                                        break;
                                    case "user":
                                        sb.Append("            $('#" + compont.field + "')[0].spvalue = learun.clientdata.get(['userinfo']).userId;\r\n");
                                ...
                                break;
                            case "upload":
                                sb.Append("            $('#" + compont.field + "').spUploader();\r\n");
                                break;
                        }
                    }
                }
                ...
                sb.Append("                $.spSetForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/GetFormData?keyValue=' + keyValue, function (data) {\r\n");
                ...
                sb.Append("                        }\r\n");
                sb.Append("                        else {\r\n");
                sb.Append("                            $('[data-table=\"' + id + '\"]').spSetFormData(data[id]);\r\n");
                sb.Append("                        }\r\n");
                sb.Append("                    }\r\n");
                sb.Append("                });\r\n");
                sb.Append("            }\r\n");
                ...
                {
                    sb.Append("        var postData = {\r\n");
                    sb.Append("            strEntity: JSON.stringify($('body').spGetFormData())\r\n");
                    sb.Append("        };\r\n");
                }
                else
                {
                    ...
                    foreach (var table in dbTableList)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                sb.Append("        postData.strEntity = JSON.stringify($('[data-table=\"" + table.name + "\"]').spGetFormData());\r\n");
                            }
                            else
                            {
                                sb.Append("        postData.str" + Str.FirstLower(table.name) + "Entity = JSON.stringify($('[data-table=\"" + table.name + "\"]').spGetFormData());\r\n");
                            }
                        }
                    }
                }
                sb.Append("        $.spSaveForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/SaveForm?keyValue=' + keyValue, postData, function (res) {\r\n");
                sb.Append("            // 保存成功后才回调\r\n");
                sb.Append("            if (!!callBack) {\r\n");
                sb.Append("                callBack();\r\n");
                sb.Append("            }\r\n");
        ...
        public string WfFormJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap,string workField)
        {
            try
            {
                ...
                sb.Append("            $.spSetForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/GetFormDataByProcessId?processId=' + processId, function (data) {\r\n");
                sb.Append("                for (var id in data) {\r\n");
                ...
                if (dbTableList.Count == 1)
                {
                    ...
                    sb.Append("        var formData = $('body').spGetFormData();\r\n");
                ...
                else
                {
                    ...
                    foreach (var table in dbTableList)
                    {
                        ...
                        else
                        {
                            if (string.IsNullOrEmpty(table.relationName))
                            {
                                sb.Append("        var formData = $('[data-table=\"" + table.name + "\"]').spGetFormData();\r\n");
                                sb.Append("        if(!!processId){\r\n");
                                sb.Append("            formData." + workField + " =processId;\r\n");
                                sb.Append("        }\r\n");
        ...
        public string GridEditFormJsCreate(BaseModel baseInfo,List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap)
        {
            try
            {
                ...
                sb.Append("            return false;\r\n");
                sb.Append("        }\r\n");
                sb.Append("        var postData = $('body').spGetFormData();\r\n");
                sb.Append("        $.spSaveForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/SaveForm', postData, function (res) {\r\n");
                sb.Append("            // 保存成功后才回调\r\n");
                sb.Append("            if (!!callBack) {\r\n");
                sb.Append("                callBack();\r\n");
                sb.Append("            }\r\n");
        ...
        public void CreateMapCodeFile(CodeBaseConfigModel codeBaseConfigModel, string tableName, string codeContent)
        {
            try
            {
                ...
                CreateCodeFile(codeBaseConfigModel.mappingDirectory + "\\" + backArea + tableName + "Map.cs", codeContent, codeBaseConfigModel.mappingDirectory + "\\Sprann.Application.Mapping.csproj", backArea + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateMapCodeFile(BaseModel baseInfo, string tableName, string codeContent)
        {
            ...
            {
                string backProject = ConfigurationManager.AppSettings["BackProject"].ToString();
                CreateCodeFile(baseInfo.mappingDirectory + "\\" + baseInfo.outputArea + "\\" + tableName + "Map.cs", codeContent, baseInfo.mappingDirectory + "\\Sprann.Application.Mapping.csproj", baseInfo.outputArea + "\\" + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", codeContent, codeBaseConfigModel.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", codeContent, baseInfo.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", codeContent, baseInfo.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", codeContent, codeBaseConfigModel.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", codeContent, baseInfo.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", codeContent, baseInfo.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", codeContent, codeBaseConfigModel.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", codeContent, baseInfo.webDirectory + "\\Sprann.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateApiFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.apiDirectory + "\\Modules\\" + baseInfo.outputArea + "\\" + baseInfo.name + "Api.cs", codeContent, baseInfo.apiDirectory + "\\Sprann.Application.WebApi.csproj", "Modules\\" + baseInfo.outputArea + "\\" + baseInfo.name + "Api.cs", false);
            }
            catch (Exception)
            {
                throw;
